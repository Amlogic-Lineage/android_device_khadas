...
TARGET_PREBUILT_KERNEL := device/khadas/braun-kernel/Image.gz
LOCAL_DTB := device/khadas/braun-kernel/braun.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/khadas/braun-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/braun-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/khadas/braun-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/braun-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/braun-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/khadas/braun-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/khadas/braun-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
...
KERNEL_DEFCONFIG := braun_defconfig
