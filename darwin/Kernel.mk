...
TARGET_PREBUILT_KERNEL := device/khadas/darwin-kernel/Image.gz
LOCAL_DTB := device/khadas/darwin-kernel/darwin.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/khadas/darwin-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/darwin-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/khadas/darwin-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/darwin-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/darwin-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/khadas/darwin-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/khadas/darwin-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
