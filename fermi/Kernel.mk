...
TARGET_PREBUILT_KERNEL := device/khadas/fermi-kernel/Image.gz
LOCAL_DTB := device/khadas/fermi-kernel/fermi.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/khadas/fermi-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/fermi-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/khadas/fermi-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/fermi-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/fermi-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/khadas/fermi-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/khadas/fermi-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
