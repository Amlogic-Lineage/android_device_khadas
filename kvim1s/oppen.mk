...
PRODUCT_GOOGLEREF_SECURE_BOOT_TOOL := ./device/amlogic/$(PRODUCT_DIR)/tools/amlogic-sign-oppen.sh
endif
...
include device/amlogic/common/products/mbox/s4/s4.mk
#########################################################################
#
##                                     Auto Patch
...
#########################################################################
PRODUCT_COPY_FILES += \
    device/amlogic/$(PRODUCT_DIR)/ueventd.parallel.rc:$(TARGET_COPY_OUT_ODM)/ueventd.rc
