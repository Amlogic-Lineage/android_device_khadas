...
DEVICE_MANIFEST_FILE += device/amlogic/common/hidl_manifests/newdevices/manifest_common.xml
DEVICE_MANIFEST_FILE += device/amlogic/common/hidl_manifests/newdevices/manifest_ir.xml
ifeq ($(TARGET_BUILD_LIVETV),true)
DEVICE_MANIFEST_FILE += device/amlogic/common/hidl_manifests/newdevices/manifest_tv.xml
DEVICE_PRODUCT_COMPATIBILITY_MATRIX_FILE += device/amlogic/common/hidl_manifests/newdevices/device_matrix_product_amlogic_tv.xml
endif
ifeq ($(PRODUCT_SUPPORT_DTVKIT),true)
DEVICE_PRODUCT_COMPATIBILITY_MATRIX_FILE += device/amlogic/common/hidl_manifests/newdevices/device_matrix_product_amlogic_dtvkit.xml
endif
ifeq ($(AB_OTA_UPDATER),true)
DEVICE_MANIFEST_FILE += device/amlogic/common/hidl_manifests/newdevices/manifest_boot.xml
endif
ifeq ($(TARGET_BUILD_IRDETO),true)
DEVICE_MANIFEST_FILE += device/amlogic/$(PRODUCT_DIR)/newdevices/manifest_irdeto.xml
endif
...
DEVICE_MANIFEST_FILE += device/amlogic/common/hidl_manifests/newdevices/manifest_wfd.xml
DEVICE_PRODUCT_COMPATIBILITY_MATRIX_FILE += device/amlogic/common/hidl_manifests/newdevices/device_matrix_product_amlogic_wfd.xml
endif
ifeq ($(TARGET_BUILD_NETFLIX_MGKID),true)
DEVICE_MANIFEST_FILE += device/amlogic/common/hidl_manifests/newdevices/manifest_netflix.xml
endif
...
#AOSP
PRODUCT_COPY_FILES += \
    device/amlogic/$(PRODUCT_DIR)/init.amlogic.board.ext.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.amlogic.board.rc
endif

ifeq ($(TARGET_BUILD_IRDETO),true)
PRODUCT_COPY_FILES += \
    device/amlogic/common/initscripts/audio.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/audio.rc
endif
...
PRODUCT_COPY_FILES += \
    ...
    device/amlogic/$(PRODUCT_DIR)/files/mesondisplay.cfg:recovery/root/sbin/mesondisplay.cfg
...
$(call inherit-product, device/amlogic/common/products/mbox/s4/device.mk)

#Dolby MS12 2.4 Decryption
include device/amlogic/common/dolby_ms12/dolby_ms12.mk
