...
TARGET_PREBUILT_KERNEL := device/khadas/faraday-kernel/Image.gz
LOCAL_DTB := device/khadas/faraday-kernel/faraday.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/khadas/faraday-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/faraday-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/khadas/faraday-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/faraday-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/faraday-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/khadas/faraday-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/khadas/faraday-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
