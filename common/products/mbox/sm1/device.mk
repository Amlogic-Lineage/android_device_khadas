...
#########################################################################
PRODUCT_COPY_FILES += \
    device/amlogic/common/products/mbox/sm1/files/remote.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/remote.cfg \
    device/amlogic/common/products/mbox/sm1/files/remote.tab1:$(TARGET_COPY_OUT_VENDOR)/etc/remote.tab1 \
    device/amlogic/common/products/mbox/sm1/files/remote.tab2:$(TARGET_COPY_OUT_VENDOR)/etc/remote.tab2 \
...
PRODUCT_COPY_FILES += \
    ...
    device/amlogic/common/products/mbox/sm1/files/remote.cfg:recovery/root/sbin/remote.cfg \
    device/amlogic/common/products/mbox/sm1/files/remote.tab1:recovery/root/sbin/remote.tab1 \
    device/amlogic/common/products/mbox/sm1/files/remote.tab2:recovery/root/sbin/remote.tab2 \
    device/amlogic/common/products/mbox/sm1/files/remote.tab3:recovery/root/sbin/remote.tab3 \
...
PRODUCT_COPY_FILES += \
    ...
    device/amlogic/common/products/mbox/sm1/recovery/sh:recovery/root/sbin/sh
