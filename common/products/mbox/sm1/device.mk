...
CHIP_DIR := device/khadas/common/products/mbox/sm1
...
#########################################################################
PRODUCT_COPY_FILES += \
    device/khadas/common/products/mbox/sm1/files/remote.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/remote.cfg \
    device/khadas/common/products/mbox/sm1/files/remote.tab1:$(TARGET_COPY_OUT_VENDOR)/etc/remote.tab1 \
    device/khadas/common/products/mbox/sm1/files/remote.tab2:$(TARGET_COPY_OUT_VENDOR)/etc/remote.tab2 \
    device/khadas/common/products/mbox/sm1/files/remote.tab3:$(TARGET_COPY_OUT_VENDOR)/etc/remote.tab3
...
PRODUCT_COPY_FILES += \
    device/khadas/common/products/mbox/sm1/recovery/remotecfg:recovery/root/sbin/remotecfg \
    device/khadas/common/products/mbox/sm1/recovery/recovery.kl:recovery/root/sbin/recovery.kl \
    device/khadas/common/products/mbox/sm1/files/remote.cfg:recovery/root/sbin/remote.cfg \
    device/khadas/common/products/mbox/sm1/files/remote.tab1:recovery/root/sbin/remote.tab1 \
    device/khadas/common/products/mbox/sm1/files/remote.tab2:recovery/root/sbin/remote.tab2 \
    device/khadas/common/products/mbox/sm1/files/remote.tab3:recovery/root/sbin/remote.tab3 \
...
PRODUCT_COPY_FILES += \
    ...
    device/khadas/common/products/mbox/sm1/recovery/sh:recovery/root/sbin/sh
...
#########################################################################
PRODUCT_COPY_FILES += \
    device/khadas/common/products/mbox/sm1/files/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles.xml \
    device/khadas/common/products/mbox/sm1/files/media_profiles_V1_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml
