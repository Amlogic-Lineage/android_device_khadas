...
PRODUCT_SBV3_SIGBL_TOOL  := ./bootloader/uboot-repo/fip/stool/amlogic-sign-tl1.sh -s tl1
...
PRODUCT_AML_SECUREBOOT_SIGNTOOL := ./bootloader/uboot-repo/fip/tl1/aml_encrypt_tl1
...
#########################################################################
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,device/khadas/common/products/mbox/g12a/files/hbg_ble/ble/b01_8.0/system/etc,vendor/etc) \
    device/khadas/common/products/mbox/g12a/files/hbg_ble/sei/init.hbg.remote.rc:/vendor/etc/init/init.hbg.remote.rc
...
PRODUCT_COPY_FILES += \
    device/khadas/common/products/tv/tl1/files/tv/dec:$(TARGET_COPY_OUT_VENDOR)/bin/dec