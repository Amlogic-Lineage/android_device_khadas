...
ifeq ($(wildcard vendor/amlogic/common/gpu/gpu-v2.mk),)
MESON_GPU_DIR=vendor/amlogic/common/gpu
include vendor/amlogic/common/gpu/gpu-v2.mk
endif
else
