...
TARGET_PREBUILT_KERNEL := device/khadas/einstein-kernel/Image.gz
LOCAL_DTB := device/khadas/einstein-kernel/einstein.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/khadas/einstein-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/einstein-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/khadas/einstein-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/einstein-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/einstein-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/khadas/einstein-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/khadas/einstein-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
...
KERNEL_DEVICETREE := txlx_t962x_r311_1g
