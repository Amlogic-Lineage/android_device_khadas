...
TARGET_PREBUILT_KERNEL := device/khadas/curie-kernel/Image.gz
LOCAL_DTB := device/khadas/curie-kernel/curie.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/khadas/curie-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/curie-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/khadas/curie-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/curie-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/khadas/curie-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/khadas/curie-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/khadas/curie-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
